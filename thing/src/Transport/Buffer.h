...
public:
  StringBuffer(const char* string) : Buffer(strlen(string)), _string(string) {
Resize(_capacity); } virtual byte* Data() { return NULL; } virtual const byte*
Data() const { return (const byte*) _string; }
};
*/
