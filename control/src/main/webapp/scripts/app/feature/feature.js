...
(function (App) {
    ...
    (function (Feature) {
        ...
        App.$module.directive(Feature.FeatureRemoteDirective.$name, [App.Repository.DeviceService.$name, function (deviceService) { return new Feature.FeatureRemoteDirective(deviceService); }]);
