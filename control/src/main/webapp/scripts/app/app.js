...
var App;
(function (App) {
    App.$module.run(function ($rootScope, $location, $window, $http, $state, $translate, Language, Auth, Principal, ENV, VERSION) {
        $rootScope.ENV = ENV;
        ...
        $stateProvider.state("site", {
            ...
            views: {
                ...
                "actionbar@": {
                    ...
                    controller: App.Component.ActionBarCtrl.$name
                },
                "sidenav@": {
                    templateUrl: "scripts/components/sidenav/sidenav.html",
                    controller: App.Component.SideNavCtrl.$name
                }
            },
            resolve: {
