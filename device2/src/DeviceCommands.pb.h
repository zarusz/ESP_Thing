...
#define DeviceMessage_ackResponse_tag            32
#define DeviceMessage_temperatureMeasureEvent_tag 64
#define DeviceMessage_movementDetectionEvent_tag 65
